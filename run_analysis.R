...
setwd("C:\\Users\\Bahus\\Desktop\\Coursera\\GettingandCleaningData\\project\\UCI HAR Dataset")

test_set <- read.table(".\\test\\X_test.txt")
train_set<- read.table(".\\train\\X_train.txt")
